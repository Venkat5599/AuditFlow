...
const headline =
  "A full audit arsenal. Static analyzers and LLM security detectors, orchestrated by signal, deduped, and graded into a Code4rena-style report with validated auto-fix pull requests, tuned for Mantle Solidity code.";
