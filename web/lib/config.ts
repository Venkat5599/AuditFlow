...
export const blurHeadlineConfig = {
  text: "31 audit skills — pashov agents, QuillAI detectors, nemesis, plus Slither and Aderyn — orchestrated by signal, deduped, and graded into a Code4rena-style report with validated auto-fix pull requests.",
};
...
export const pricingConfig = {
  title: "The arsenal",
  description: "31 audit skills + 7 Mantle detectors + 2 static analyzers, routed by signal — not all at once.",
