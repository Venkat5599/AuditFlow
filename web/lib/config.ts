...
export const blurHeadlineConfig = {
  text: "A full audit arsenal. Static analyzers and LLM security detectors, orchestrated by signal, deduped, and graded into a Code4rena-style report with validated auto-fix pull requests, tuned for Mantle Solidity code.",
};
...
export const pricingConfig = {
  title: "The arsenal",
  description: "A full audit arsenal + Mantle L2 detectors + static analyzers, routed by signal — not all at once.",
